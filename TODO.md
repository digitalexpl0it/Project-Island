...
- [ ] **Rope HUD (client):** sync rope stats from server; draw **health** (and optional tension readout) at **both** anchor ends (billboard or attachment-style UI, similar pipeline to `RopeLinkSyncPayload` / `RopeLinkSegmentRenderer`).
