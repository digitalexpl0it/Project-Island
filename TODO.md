...
- [ ] **Rope topology enforcement (server):** reject new harpoon links / claims that would add a **fourth** hop from starter or outbound links from a **leaf tertiary**; enforce **advancement-backed caps** on main spokes and per-sister spokes (see design bullet above).
