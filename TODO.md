...
- [ ] **Island HUD polish (optional):** datapack or JSON-driven name word lists; custom atlas icon instead of vanilla item stacks; panel **scale** / full color picker. **Done in-repo:** billboard **fill + border opacity** — `projectisland-client.toml` **`islandHudPanelFillOpacity`**, **`islandHudPanelBorderOpacity`** (0–1).
