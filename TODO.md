...
- [ ] **Ambient dragons (Bluedude Dragons):** shelved — **BlueLib** + **BDD** removed from manifest and PI compat (alpha; split-client BlueLib cache issues). **Wings Of Fire** remains quest/loot mounts. Revisit when mod/API stabilizes.
- [ ] **Other ambient creatures:** [Mowzie's Mobs](https://modrinth.com/mod/mowzies-mobs) etc. — **BOP-only** island tops can look sparse unless you extend tags in a datapack (see [MOD_LIST.md](MOD_LIST.md) *Mowzie's Mobs + Biomes O' Plenty*).
