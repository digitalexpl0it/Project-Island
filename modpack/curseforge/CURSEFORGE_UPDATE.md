...
**Pack version:** **1.3.0** · **Minecraft** **1.21.1** · **NeoForge** **21.1.227** (see `gradle.properties` and `manifest.json`).
...
- **Realm RPG: Treasure Balloons** updated to **`realmrpg_balloons-1.0.0-neoforge-1.21.1.jar`** (CurseForge file **8073660**).
- **Project Island** (worldgen + ropes + HUD, etc.): **`projectisland-1.3.0.jar`** (CurseForge file **8090568**).

**This release — pack content (high level)**

- Same **1.3.0** feature set as repo **`CHANGELOG_CLIENT.md`** (inventory HUD defaults, Xaero defaults, FTB quest fixes, etc.).
